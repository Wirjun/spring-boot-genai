    ...
    public static String answer(String question, Map<String, String> context) {
        try {
            ...
            messages.put(new JSONObject()
                    .put("role", "system")
                    .put("content", "You will answer the question according to the knowledge provided. If the word \"unknown\" is provided you will not answer the question. When information from the context is available, you will answer the question to the user!"));
